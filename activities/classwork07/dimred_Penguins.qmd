...
1)  Access the Quarto document [here](https://github.com/lindsaynhayes/introR2026/blob/main/activities/classwork07/dimred_Penguins.qmd).
...
penguin_bake |> ggplot(aes(x = UMAP1, y = UMAP3, color = sex)) +
  geom_point(alpha = .5)

penguin_bake |> ggplot(aes(x = UMAP2, y = UMAP3, color = sex)) +
  geom_point(alpha = .5)
