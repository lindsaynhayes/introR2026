...
This is a Quarto document that you can [download](https://github.com/lindsaynhayes/introR2026/blob/main/activities/classwork01/palmerpenguins_intro.qmd) from the [github repository for the course](https://github.com/lindsaynhayes/introR2026), and as you see below there is a combination of narrative text, code chunks, code outputs, citations/references, embedded links, and even embedded static images. Quarto documents are highly customizable and the purpose is to generate a story-telling narrative of data by incorporating all these components into a single document.
