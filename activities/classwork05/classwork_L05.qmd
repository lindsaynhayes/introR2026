...
ggplot(taylor_album_songs, aes(x = key_name)) + geom_bar()
ggplot(taylor_album_songs, aes(x = key_name, fill = album_name)) + geom_bar()

ggplot(taylor_album_songs, aes(y = album_name, fill = key_name)) + geom_bar()

taylor_album_songs |> drop_na(key) |>
  ggplot(aes(y = album_name, fill = key)) + geom_bar()
...
penguins |> ggplot(aes(x = bill_length_mm, y = bill_depth_mm, color = flipper_length_mm, size = body_mass_g, shape = species)) + 
  geom_point() +
