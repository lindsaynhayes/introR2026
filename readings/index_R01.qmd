...
How to Create a [RStudio project](https://support.posit.co/hc/en-us/articles/200526207-Using-RStudio-Projects)

![](figs/Create_RStudio_Project.gif){width="100%\"/" style="float:right" fig-align="center"}

2.  R Project Directory Structure (for data science and for life)

Here's an example of a tidy project data management.
