...
To get started a key concept is what the data looks like and what an **operation** or **function** is that can then be applied to the data. ::: callout-important \## DATA TYPES
...
counts <- read.csv("readings/data/counts.csv", row.names = 1)
genes <- read.csv("readings/data/gene_metadata.csv")
samples <- read.csv("readings/data/sample_metadata.csv")
```
