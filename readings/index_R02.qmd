...
## Data: What is it and how to store and access it in R?
...
A **function** in `R` is indicated by having `()` after the command. For example, `mean()`, `sd()`, or `count()`, these are all functions that can be applied to data. But knowing what functions can apply to different types of data is important.
