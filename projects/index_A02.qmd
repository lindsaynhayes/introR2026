...
2.  **Navigate** to this [link](https://github.com/lindsaynhayes/introR2026/tree/main/swirl). **Download** the Swirl lesson file `2_Exploratory_Data_Analysis.swc`. **Move** it into your working directory for the class.
