...
-   Location: In person, Summer 2026
-   Dates: 7/6/2026 - 7/31/2026
-   Course time: 10:00am - 11:30am CST
...
-   Course website: <https://lindsaynhayes.github.io/introR2026>
-   GitHub repository with all course material: <https://github.com/lindsaynhayes/introR2026>
...
In addition, students need to have **R** and **R Studio** installed on their computers before the first class session. Detailed information on this can be found on [swirl](https://swirlstats.com/students.html).
...
Reach out to the TA (Eleana Cabello) or the instructor (Dr. Hayes)
...
-   Turn in Homework through R submssion on swirl.

-   The Final project is to identify a data processing problem or question, develop a script to solve the problem, and present the process in a final 10-minute presentation. Provide access to the qmd and report through a website on GitHub.
...
|:----:|:-----:|-------------------------------------|-----------------------------|
| 7/6  |  01   | Intro to R/RStudio                  |                             |
| 7/8  |  02   | Literate Coding with Quarto         |                             |
| 7/10 |  03   | EDA & Coding Syntax                 | Homework 1 (due 7/13)       |
| 7/13 |  04   | Data Wrangling with tidyverse       |                             |
| 7/15 |  05   | Data Visualization with ggplot2     | Homework 2 (due 7/20)       |
| 7/17 |  06   | Functions and Loops                 |                             |
| 7/20 |  07   | Dimension Reduction with tidymodels | Homework 3 (due 7/27)       |
| 7/22 |  08   | Machine Learning with tidymodels    |                             |
| 7/24 |  09   | Building a Portfolio in GitHub      |                             |
| 7/27 |  10   | In-Class Work on Final              | Final project proposal due  |
| 7/29 |  11   | Final Project Presentations         | Presentation                |
| 7/31 |  12   | Final Project Presentations         | Presentation and evaluation |
...
Refer to the LLM section of the downloadable syllabus for more information on use of LLMs.
:::
